...
# get mm9_refFlat file and sort by cisgenome, preparing for annoPeak
wget http://hgdownload.cse.ucsc.edu/goldenPath/mm9/database/refFlat.txt.gz
zcat refFlat.txt.gz | grep -vP "chr.*_random" > refFlat.txt
${cisgenome_bin_dir}/refflat_encode -d refFlat.txt -o mm9_refFlat_sorted.txt -s mouse -n 21
